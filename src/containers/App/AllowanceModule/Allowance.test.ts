...
describe('Allowance', () => {
	it('Calculate total irregular hours with a N-shift that spans across 2 different months', async () => {
		...
		const allowanceObtained = await new Allowance().compute(parsedEvents);
